"""
Django settings for Professional_Networking_Platform project.
...
SECRET_KEY = 'django-insecure-mc8&aendq$+$hazn#lx7#r+)at8nl@ict)r3wou6q%u08bm)9('
...
ROOT_URLCONF = 'Professional_Networking_Platform.urls'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'PNP/static/PNP/media')
